    ...
    <form action="<?= $action; ?>" method="post">
        <div class="container me-1">
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-5">
                    <input type="password" id="register_password" class="form-control" name="register_password" minlength="8" title="<?= __('8 characters minimum, including uppercase, lowercase, digit and special character'); ?>">
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-5">
                    <input type="password" id="register_repeat_password" class="form-control" name="register_repeat_password" minlength="8" title="<?= __('8 characters minimum, including uppercase, lowercase, digit and special character'); ?>">
                </div>
            </div>
