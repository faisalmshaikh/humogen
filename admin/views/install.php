...
?>
    ...
    if (!$install['table_users'] || isset($_POST["table_users"])) {
        ...
        $dbh->query("CREATE TABLE humo_users (
            ...
            user_reference_name varchar(100) CHARACTER SET utf8 DEFAULT '',
            user_address text CHARACTER SET utf8,
            user_marital_status varchar(20) CHARACTER SET utf8 DEFAULT '',
            user_paternal_grandparent_names varchar(200) CHARACTER SET utf8 DEFAULT '',
            user_maternal_grandparent_names varchar(200) CHARACTER SET utf8 DEFAULT '',
            user_phone varchar(50) CHARACTER SET utf8 DEFAULT '',
