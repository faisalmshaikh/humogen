    ...
    public function getGraph(string $gedcomNumber): array
    {
        ...
        foreach ($allPeople as $person) {
            ...
            $people[(int) $person->pers_id] = [
                ...
                'name' => htmlspecialchars($privacy ? __('Name filtered') : $firstName, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
                'first_name' => htmlspecialchars($privacy ? __('Name filtered') : $firstName, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
                'sex' => $person->pers_sexe,
                'birth_date' => htmlspecialchars($privacy ? '' : ($person->pers_birth_date ?? ''), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
                'death_date' => htmlspecialchars($privacy ? '' : ($person->pers_death_date ?? ''), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
